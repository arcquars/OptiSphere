...
class BranchManagerCode extends Page
{
    protected string $view = 'filament.branch-manager.pages.branch-manager-code';
    ...
    {
        return 'store/{branchId}/manage-code'; // URL: /admin/branches/manage
    }
