...
<div class="row header">
    <div class="col col-6" style="text-align: center">
        <img src="{{ public_path('img/android-chrome-192x192.png') }}" alt="Logo" style="max-width: 40px; height: auto;">
        <div class="title" style="color: red; font-size: 12px;">{{ config('cerisier.company_name') }}</div>
    ...
    <div class="col col-6">
        <div class="">
            <div class="row">
                <div class="col">
                    <div class="subtitle right" style="font-size: 24px">RECIBO</div>
...
<table style="border: 0px !important; border-collapse: collapse !important; border-spacing: 0 !important;">
    <tbody>
    <tr>
...
<table style="width:100%; border: 0px !important; border-collapse: collapse !important; border-spacing: 0 !important;">
    <tbody>
    <tr>
        <td class="label" style="text-align: right; width: 70%; border: 0; padding: 0;"><strong>SUBTOTAL</strong></td>
        <td class="value" style="width: 30%; text-align: right; border: 0; padding: 0;">{{ m($subtotal) }}</td>
    </tr>
    <tr>
        <td class="label" style="text-align: right; border: 0; padding: 0;"><strong>DESCUENTO</strong></td>
        <td class="value" style="text-align: right; border: 0; padding: 0;">{{ m($discountTotal) }}</td>
    </tr>
    <tr>
        <td class="label" style="text-align: right; border: 0; padding: 0;"><strong>TOTAL</strong></td>
        <td class="value" style="text-align: right; border: 0; padding: 0;">{{ m($total) }}</td>
    </tr>
    <tr>
        <td class="label" style="text-align: right; border: 0; padding: 0;"><strong>MONTO A PAGAR</strong></td>
        <td class="value" style="text-align: right; border: 0; padding: 0;"><strong>{{ m($total) }}</strong></td>
    </tr>
    </tbody>
</table>
...
<table style="border: 0px !important; border-collapse: collapse !important; border-spacing: 0 !important;">
    ...
    <tr>
        ...
        <td style="border: 0px; padding: 0; text-align: right">
