...
return new class extends Migration
{
    ...
    {
        Schema::create('siat_data_productos', function (Blueprint $table) {
            $table->id();
        ...
        Schema::table('siat_data_productos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('siat_data_productos');
    }
};
